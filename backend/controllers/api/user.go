...
// 获取当前登录用户
func (c *User) GetCurrent() *simple.JsonResult {
...
// 用户详情
func (c *User) GetBy(userId int64) *simple.JsonResult {
...
// 用户积分
func (c *User) GetScoreBy(userId int64) *simple.JsonResult {
	score := cache.UserCache.GetScore(userId)
	return simple.NewEmptyRspBuilder().Put("score", score).JsonResult()
}

// 修改用户资料
func (c *User) PostEditBy(userId int64) *simple.JsonResult {
	user := services.UserTokenService.GetCurrent(c.Ctx)
	if user == nil {
...
// 修改头像
func (c *User) PostUpdateAvatar() *simple.JsonResult {
	user := services.UserTokenService.GetCurrent(c.Ctx)
	if user == nil {
		return simple.JsonError(simple.ErrorNotLogin)
	}
...
// 设置用户名
func (c *User) PostSetUsername() *simple.JsonResult {
	user := services.UserTokenService.GetCurrent(c.Ctx)
	if user == nil {
		return simple.JsonError(simple.ErrorNotLogin)
	}
...
// 设置邮箱
func (c *User) PostSetEmail() *simple.JsonResult {
	user := services.UserTokenService.GetCurrent(c.Ctx)
	if user == nil {
		return simple.JsonError(simple.ErrorNotLogin)
	}
...
// 设置密码
func (c *User) PostSetPassword() *simple.JsonResult {
	user := services.UserTokenService.GetCurrent(c.Ctx)
	if user == nil {
		return simple.JsonError(simple.ErrorNotLogin)
	}
...
// 修改密码
func (c *User) PostUpdatePassword() *simple.JsonResult {
	user := services.UserTokenService.GetCurrent(c.Ctx)
	if user == nil {
		return simple.JsonError(simple.ErrorNotLogin)
	}
...
// 设置背景图
func (c *User) PostSetBackgroundImage() *simple.JsonResult {
	user := services.UserTokenService.GetCurrent(c.Ctx)
	if user == nil {
		return simple.JsonError(simple.ErrorNotLogin)
	}
...
// 用户收藏
func (c *User) GetFavorites() *simple.JsonResult {
	user := services.UserTokenService.GetCurrent(c.Ctx)
...
// 获取最近3条未读消息
func (c *User) GetMsgrecent() *simple.JsonResult {
	user := services.UserTokenService.GetCurrent(c.Ctx)
	var count int64 = 0
...
// 用户消息
func (c *User) GetMessages() *simple.JsonResult {
	user := services.UserTokenService.GetCurrent(c.Ctx)
...
// 最新用户
func (c *User) GetNewest() *simple.JsonResult {
...
// 用户积分记录
func (c *User) GetScorelogs() *simple.JsonResult {
	page := simple.FormValueIntDefault(c.Ctx, "page", 1)
	user := services.UserTokenService.GetCurrent(c.Ctx)
	// 用户必须登录
	if user == nil {
...
// 积分排行
func (c *User) GetScoreRank() *simple.JsonResult {
...
// 禁言
func (c *User) PostForbidden() *simple.JsonResult {
	user := services.UserTokenService.GetCurrent(c.Ctx)
	if user == nil {
		return simple.JsonError(simple.ErrorNotLogin)
	}
...
func (c *User) PostEmailVerify() *simple.JsonResult {
	user := services.UserTokenService.GetCurrent(c.Ctx)
	if user == nil {
		return simple.JsonError(simple.ErrorNotLogin)
	}
...
func (c *User) GetEmailVerify() *simple.JsonResult {
	user := services.UserTokenService.GetCurrent(c.Ctx)
	if user == nil {
		return simple.JsonError(simple.ErrorNotLogin)
	}
...
// // PostCheckin 签到
// func (c *User) PostCheckin() *simple.JsonResult {
// 	user := services.UserTokenService.GetCurrent(c.Ctx)
...
// // GetCheckin 获取签到信息
// func (c *User) GetCheckin() *simple.JsonResult {
// 	user := services.UserTokenService.GetCurrent(c.Ctx)
// 	if user == nil {
// 		return simple.JsonSuccess()
// 	}
