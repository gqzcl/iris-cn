...
import (
	...
	"github.com/gqzcl/simple/number"
...
func (s *sysConfigService) GetConfig() *model.SysConfigResponse {
	var (
		...
		recommendTags         = cache.SysConfigCache.GetValue(constants.SysConfigSiteRecommendTags)
		urlRedirect           = cache.SysConfigCache.GetValue(constants.SysConfigSiteURLRedirect)
